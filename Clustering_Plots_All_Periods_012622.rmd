...
load(str_c(drive, '/Manuscript/Scan_SMERC_periods_1_3_vsets_1_2_Results.RData'))
...
# Lung Cancer
## All sexes
```{r Lung cancer cluster plots, fig.width=7.5, fig.height = 8.4}
tmap::tmap_arrange(
