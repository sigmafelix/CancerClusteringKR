...
# Lung Cancer
## All sexes
```{r Lung cancer cluster plots, fig.width=8, fig.height = 10}
tmap::tmap_arrange(
...
## Female
```{r Lung: sex stratified (female), fig.width=8, fig.height = 10}
...
## Male
```{r Lung: sex stratified (male), fig.width=8, fig.height = 10}
...
# Stomach cancer
## All sexes
```{r Stomach cancer cluster plots, fig.width=8, fig.height = 10}
tmap::tmap_arrange(
...
## Female
```{r Stomach (female), fig.width=8, fig.height = 10}
tmap::tmap_arrange(
    ...
    tmap_smerc(covar_origin_05_fc, smerc_stom_2if_v2, return_ellipses = TRUE) + 
        tm_layout(title = 'Stomach cancer incidence\n(2004-208, Female, Variable set 2)', frame = FALSE),
...
## Male
```{r Stomach (Male), fig.width=8, fig.height = 10}
tmap::tmap_arrange(
    ...
    tmap_smerc(covar_origin_05_fc, smerc_stom_2im_v2, return_ellipses = TRUE) + 
        tm_layout(title = 'Stomach cancer incidence\n(2004-208, Male, Variable set 2)', frame = FALSE),
