...
for (k in seq.int(1, nrow(sss_incidence_sf_venv_p))) {
    sss_incidence_sf_venv_p$geom[[k]] = sss_incidence_sf_venv_p$geom[[k]] + st_point(c(-1.35e5, 2e5), dim = 'XY')    
}
for (k in seq.int(1, nrow(sss_mortality_sf_venv_p))) {
    sss_mortality_sf_venv_p$geom[[k]] = sss_mortality_sf_venv_p$geom[[k]] + st_point(c(-1.35e5, 2e5), dim = 'XY')    
}
...
sss_incidence_sf_venv %>%
    ...
    tm_shape(.) +
        ...
        tm_borders('dark grey', lwd = 0.4) +
        tm_facets(by = c("year", "cancersex"), nrow = 3, ncol = 3) +
        tm_shape(sss_incidence_sf_venv_p) +
        tm_text("nflag", size = 1.5, remove.overlap = TRUE) +
        tm_facets(by = c("year", "cancersex"), nrow = 3, ncol = 3) +
        tm_layout(panel.label.bg.color = 'transparent',
                  title = "Incidence rate\n(Base+Environment)",
...
sss_mortality_sf_venv %>%
    ...
    tm_shape(.) +
        ...
        tm_borders('dark grey', lwd = 0.4) +
        tm_facets(by = c("year", "cancersex"), nrow = 3, ncol = 3) +
        tm_shape(sss_mortality_sf_venv_p) +
        tm_text("nflag", size = 1.5, remove.overlap = TRUE) +
        tm_facets(by = c("year", "cancersex"), nrow = 3, ncol = 3) +
        tm_layout(panel.label.bg.color = 'transparent',
                  title = "Mortality rate\n(Base+Environment)",
