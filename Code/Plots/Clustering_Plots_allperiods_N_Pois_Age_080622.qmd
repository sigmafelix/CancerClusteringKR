...
# Lung Cancer
```{r Lung cancer cluster plots, fig.width=12, fig.height = 5.6}
...
tmap::tmap_arrange(
    tmap_satscan(covar_origin_00_fc, p_va_resl[["Lung_p1_i_n_male_va"]]) + 
            tm_layout(title = 'Lung cancer incidence count\n(1999-2003, Male, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_05_fc, p_va_resl[["Lung_p2_i_n_male_va"]]) + 
            tm_layout(title = 'Lung cancer incidence count\n(2004-2008, Male, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_10_fc, p_va_resl[["Lung_p3_i_n_male_va"]]) + 
...
tmap::tmap_arrange(
    tmap_satscan(covar_origin_00_fc, p_va_resl[["Lung_p1_d_n_male_va"]]) + 
            tm_layout(title = 'Lung cancer mortality count\n(1999-2003, Male, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_05_fc, p_va_resl[["Lung_p2_d_n_male_va"]]) + 
            tm_layout(title = 'Lung cancer mortality count\n(2004-2008, Male, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_10_fc, p_va_resl[["Lung_p3_d_n_male_va"]]) + 
            tm_layout(title = 'Lung cancer mortality count\n(2009-2013, Male, age variable)', frame = FALSE), ncol=3)
...
```{r stomach: sex stratified, fig.width=12, fig.height = 5.6}
...
tmap::tmap_arrange(
    tmap_satscan(covar_origin_00_fc, p_va_resl[["Stomach_p1_i_n_male_va"]]) + 
            tm_layout(title = 'Stomach cancer incidence count\n(1999-2003, Male, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_05_fc, p_va_resl[["Stomach_p2_i_n_male_va"]]) + 
            tm_layout(title = 'Stomach cancer incidence count\n(2004-2008, Male, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_10_fc, p_va_resl[["Stomach_p3_i_n_male_va"]]) + 
            tm_layout(title = 'Stomach cancer incidence count\n(2009-2013, Male, age variable)', frame = FALSE), ncol=3)
...
tmap::tmap_arrange(
    tmap_satscan(covar_origin_00_fc, p_va_resl[["Stomach_p1_d_n_male_va"]]) + 
            tm_layout(title = 'Stomach cancer mortality count\n(1999-2003, Male, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_05_fc, p_va_resl[["Stomach_p2_d_n_male_va"]]) + 
            tm_layout(title = 'Stomach cancer mortality count\n(2004-2008, Male, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_10_fc, p_va_resl[["Stomach_p3_d_n_male_va"]]) + 
            tm_layout(title = 'Stomach cancer mortality count\n(2009-2013, Male, age variable)', frame = FALSE), ncol=3)
...
tmap::tmap_arrange(
    tmap_satscan(covar_origin_00_fc, p_va_resl[["Stomach_p1_i_n_female_va"]]) + 
            tm_layout(title = 'Stomach cancer incidence count\n(1999-2003, Female, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_05_fc, p_va_resl[["Stomach_p2_i_n_female_va"]]) + 
            tm_layout(title = 'Stomach cancer incidence count\n(2004-2008, Female, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_10_fc, p_va_resl[["Stomach_p3_i_n_female_va"]]) + 
...
tmap::tmap_arrange(
    tmap_satscan(covar_origin_00_fc, p_va_resl[["Stomach_p1_d_n_female_va"]]) + 
            tm_layout(title = 'Stomach cancer mortality count\n(1999-2003, Female, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_05_fc, p_va_resl[["Stomach_p2_d_n_female_va"]]) + 
            tm_layout(title = 'Stomach cancer mortality count\n(2004-2008, Female, age variable)', frame = FALSE),
    tmap_satscan(covar_origin_10_fc, p_va_resl[["Stomach_p3_d_n_female_va"]]) + 
            tm_layout(title = 'Stomach cancer mortality count\n(2009-2013, Female, age variable)', frame = FALSE), ncol=3)
