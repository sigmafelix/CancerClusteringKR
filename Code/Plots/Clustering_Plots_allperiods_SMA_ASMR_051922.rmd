...
covar_origin_10_fc = covar_origin_10_fc %>%
    filter(!sgg_cd_c %in% c(23320, 37430) & grepl('^(11|23|31)', sgg_cd_c)) %>%
...
p_v0_resl = clear_input(filepath = str_c(rdsdir, "satscan_ASMR_SMA_uncontrolled_resid.rds"))
p_v1_resl = clear_input(filepath = str_c(rdsdir, "satscan_ASMR_SMA_vset1_resid.rds"))
p_v2_resl = clear_input(filepath = str_c(rdsdir, "satscan_ASMR_SMA_vset2_resid.rds"))
p_v3_resl = clear_input(filepath = str_c(rdsdir, "satscan_ASMR_SMA_vset3_resid.rds"))
p_v4_resl = clear_input(filepath = str_c(rdsdir, "satscan_ASMR_SMA_vset4_resid.rds"))
