...
### Sensitivity May 2023
run_satscan = function(
    data = dat3,
    filename = "satscan_base_data_period3.csv",
    vset = "set3_nondvi",
    indices = indx_p3,
    geoid = "sgg_cd_c"
) {
    mapply(function(x, y) {
    generate_satscan_prm(data = data,
                    title.analysis = str_c(y, vset),
                    dir.base = dbase, dir.target = "/home/felix/workcache/", name.idcol = geoid,
                    filename.input = filename,
                    filename.output = str_c(str_c(y, vset), ".txt"),
                    col.var = x,
                    col.case = x,
                    prm.path = "/home/felix/Documents/test.prm",
                    adjust = TRUE,
    ...
    }, all_models$basename[indices], all_models$modeltitle[indices], SIMPLIFY = FALSE)
}
...
p1_all_nondvi = run_satscan(dat1, "satscan_base_data_period1.csv", vset="set3_nondvi", indices = indx_p1)
p1_all_noappred = run_satscan(dat1, "satscan_base_data_period1.csv", vset="set3_noappred", indices = indx_p1)
p1_all_noapsum = run_satscan(dat1, "satscan_base_data_period1.csv", vset="set3_noapsum", indices = indx_p1)

p2_all_nondvi = run_satscan(dat2, "satscan_base_data_period2.csv", vset="set3_nondvi", indices = indx_p2)
p2_all_noappred = run_satscan(dat2, "satscan_base_data_period2.csv", vset="set3_noappred", indices = indx_p2)
p2_all_noapsum = run_satscan(dat2, "satscan_base_data_period2.csv", vset="set3_noapsum", indices = indx_p2)

p3_all_nondvi = run_satscan(dat3, "satscan_base_data_period3.csv", vset="set3_nondvi", indices = indx_p3)
p3_all_noappred = run_satscan(dat3, "satscan_base_data_period3.csv", vset="set3_noappred", indices = indx_p3)
p3_all_noapsum = run_satscan(dat3, "satscan_base_data_period3.csv", vset="set3_noapsum", indices = indx_p3)


p1_all_nondvi_df = Reduce(rbind, p1_all_nondvi)
p1_all_noappred_df = Reduce(rbind, p1_all_noappred)
p1_all_noapsum_df = Reduce(rbind, p1_all_noapsum)

p2_all_nondvi_df = Reduce(rbind, p2_all_nondvi)
p2_all_noappred_df = Reduce(rbind, p2_all_noappred)
p2_all_noapsum_df = Reduce(rbind, p2_all_noapsum)

p3_all_nondvi_df = Reduce(rbind, p3_all_nondvi)
p3_all_noappred_df = Reduce(rbind, p3_all_noappred)
p3_all_noapsum_df = Reduce(rbind, p3_all_noapsum)

p13_all_nondvi_df = bind_rows(p1_all_nondvi_df, p2_all_nondvi_df, p3_all_nondvi_df)
p13_all_noappred_df = bind_rows(p1_all_noappred_df, p2_all_noappred_df, p3_all_noappred_df)
p13_all_noapsum_df = bind_rows(p1_all_noapsum_df, p2_all_noapsum_df, p3_all_noapsum_df)
